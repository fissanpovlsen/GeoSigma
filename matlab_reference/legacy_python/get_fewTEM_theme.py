...
def get_fewTEM_theme(UTM_X, UTM_Y, terrain, complexity, reg, include_peatlands, Npreq, NPL, Nlay):
    # Load data based on region
    region_files = {
        'Jylland': 'jylland_tem_faalag_til_usikkerhed.mat',
        'Fyn': 'fyn_tem_til_usikkerhed.mat',
        'Sjælland': 'Sjaelland_tem_faalag_til_usikkerhed.mat'
    }
    ...
    var0map = (np.maximum(1.2, 0.5 * 0.15 * local_depth) + 2)**2
