...
def get_tTEM_theme(UTM_X, UTM_Y, terrain, complexity, reg, include_peatlands, Npreq, NPL, Nlay):
    ...
    region_files = {
        'Jylland': 'Jylland_ttem_til_usikkerhed.mat'
        # Fyn and Sjælland not defined in MATLAB code
    }
    ...
    SearchRadius = 6
    comp2range = [100, 100, 100, 100, 100]
    comp2rangePreq = [100] * 5

    # Certainty function for tTEM
